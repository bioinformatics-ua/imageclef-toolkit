...
def efficientnet_params(model_name):
  ...
  params_dict = {
      ...
      'efficientnet-b-1': (0.5, 0.5, 112, 0.1),
      'efficientnet-b0': (1.0, 1.0, 224, 0.2),
      'efficientnet-b1': (1.0, 1.1, 240, 0.2), # + 16
      'efficientnet-b2': (1.1, 1.2, 260, 0.3), # + 20
      'efficientnet-b3': (1.2, 1.4, 300, 0.3), # + 40
      'efficientnet-b4': (1.4, 1.8, 380, 0.4), # + 80
      'efficientnet-b5': (1.6, 2.2, 456, 0.4), # + 76
      'efficientnet-b6': (1.8, 2.6, 528, 0.5), # + 72
      'efficientnet-b7': (2.0, 3.1, 600, 0.5), # + 72
  }
